...
import { Card, CardHeader, Avatar, CardContent, Typography, Button, makeStyles } from '@material-ui/core'
    ...
    return (
        <Card className={classes.root}>
            ...
            <div className={classes.details}>
                ...
                <CardContent>
                    <Typography variant='h5' className={classes.title}>Would you rather</Typography>
                    <Typography variant='subtitle2' className={classes.subTitle}>{'...' + answer.substr(0, 11) + '...'}</Typography>
                    <Link to={url + id} style={{'textDecoration':'none'}}>
                        <Button variant='outlined' color='primary'>View Poll</Button>
                    </Link>
                </CardContent>
            </div>
        </Card>
